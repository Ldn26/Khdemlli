...
function PainTing() {
  return (
    <div >
      <Header/>
      <Banner content={"Service & maintenance"}/>
       <div></div>
          ...
          <div className='flex flex-col w-1/2  right-[50x] mx-auto  mt-20 '>
      <img src={img} className=' w-[500px] hover:scale-100 duration-300  h-[300px] md:h-[450px] md:w-[760px] md:rounded-xl rounded-full' />
      <h1 className='  text-[#1C2752] text-3xl bold   '> Description for Service & maintenance</h1>
