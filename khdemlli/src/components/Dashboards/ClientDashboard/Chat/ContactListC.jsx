...
import ContactItemC from './ContactItemC';

function ContactListC({messages,user_id}) {
 // console.log("COntact List")
 //console.log(messages)
// console.log(user_id)
  return (
    <>
          <div className="  duration-500  p-2  overflow-x-hidden h-screen   bg-white text-white">
            <SearchfromList />
