...
function SettingsW() {
  ...
  //  const cld = new Cloudinary({ cloud: { cloudName: "dwsy4kzht" } });
  //  console.log(cld)
 ...
 console.log("Token")
  ...
  const present_key = "youcef";
  const cloudName = "dwsy4kzht";
  const handleChangeProfileimage = (e) => {
    const selectedimage = e.target.files[0];

    const DataForm = new FormData();
    DataForm.append("file ", selectedimage);
    DataForm.append("upload_preset", present_key);
            ...
            <DialogContent className=" p-10  max-w-[860px] h-[600px]">
              <DialogHeader>
                ...
                <DialogDescription className="p-4 relative">
                  <button
                    onClick={sendData}
                    className="text-sm flex   absolute right-0 top-[50px] hover:bg-orangeColor ml-10  h-7 whitespace-nowrap  rounded  w-fit text-white bg-blueColor  duration-500 hover:text-blueColor font-semibold px-3 py-1 "
                  >
                    Save Changes
                  </button>
                  <div className="flex ml-10 items-center">
            ...
            <div className="flex mb-4 justify-between">
              <div className="flex flex-col justify-center mr-2">
                ...
                <input
                  ...
                  placeholder="first name"
                  className="placeholder:text-gray-400 rounded font-semibold 	cursor-default text-[16px]   
               w-[316px] p-1   border  shadow-sm outline-none -blueColor font-mainfont duration-400"
                />
              </div>{" "}
              <div className="flex flex-col justify-center ">
                ...
                <input
                  ...
                  value={data.image}
                  readOnly
                  className="placeholder:text-gray-400 rounded font-semibold text-[16px]  	cursor-default  
                p-1 w-[350px]  border  shadow-sm outline-none -blueColor font-mainfont duration-400"
                />
              </div>
            </div>
            ...
            <div className="flex my-4 justify-around items-center">
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  readOnly
                  className="p-2 border h-40 resize-none cursor-default"
