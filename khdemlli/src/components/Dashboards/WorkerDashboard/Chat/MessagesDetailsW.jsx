...
import ChatInputW from "./ChatInputW";
import ContactListW from "./ContactListW";

function MessagesDetailsW() {
  ...
  console.log(baseUrl + "/get_messages/" + user_id + "/" + id.id);
  useEffect(() => {
  ...
  return (
    <div className="w-3/5 border h-screen flex  justify-between ">
      ...
      <div className="w-4/12 h-screen border">
        {isSuccessList && (
          <Scrollbars style={{ width: "100%", height: "100%" }}>
            <ContactListW user_id={user_id} messages={LatestMessages} />
          </Scrollbars>
        )}
        {isLoadingList && (
      ...
      <div className=" flex w-8/12   items-center ">
        {isSuccessPrv && (
          <Scrollbars style={{ width: "100%", height: "100%" }}>
            <div className="container  h-screen overflw-y-scroll   mx-auto">
              ...
              <div className="h-[600px] overflw-y-scroll ">
              ...
              <div className="relatie">
                <ChatInputW user_id={user_id} token={token} sender_id={id.id} />
              </div>
            </div>
          </Scrollbars>
        )}
...
export default MessagesDetailsW;
