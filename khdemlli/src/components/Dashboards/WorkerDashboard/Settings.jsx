...
function Settings() {
 ...
 const [UpdatedPrvWorks ,SetUpdatedPrvWorks ] =useState([]) 
  ...
  const [newPevWork,SetnewPrvWork] = useState("")  
...
const handelChangePrvWorks = (e)=>{
  ...
  reader.readAsDataURL(selectedPrvJob)
  SetUpdatedPrvWorks([... UpdatedPrvWorks,newPevWork ]);
}
    ...
    <>
      {isSuccess && (
        <div className=" w-3/5 flex  justify-center  overflow-hidden flex-col">
          ...
          <div className="fle items-cente mt-7 ">
            <Dialog className="w-[1200px]  bg-blueColor ">
              <DialogTrigger className="text-sm flex  bg-orangeCol ml-10  h-7 whitespace-nowrap  rounded bg-orangeColor w-fit text-blueColor hover:bg-blueColor duration-500 hover:text-orangeColor font-semibold px-3 py-1 ">
                Edit Profile
              </DialogTrigger>
                ...
                p-1 w-[350px]  border  shadow-sm outline-none -blueColor font-mainfont duration-400"
                      ...
                      <div className="flex my-4 justify-between items-center">
                        <div className="flex flex-col">
                          ...
                          <textarea
                            id="desc"
                            className="p-2 font-semibold font-mainfont"
                            value={UpdatedDesc}
                            onChange={(e) => {
                        ...
                        <div className="flex flex-col">
                          ...
                          <textarea
                            id="exp"
                            value={UpdatedExp}
                            className="p-2 font-mainfont font-semibold "
                            onChange={(e) => {
            ...
            {/* the form  */}
            <div
              className={` border-l ml-10 pl-4 mt-7 border-gray-700 flex  flex-col  
