  ...
  return (
    <div className="container my-10 mx-auto  py-10 flex items-center flex-col">
      ...
      <div className="flex justify-center items-center">
        <div className="flex bg-orangeColor w-[300px] h-[250px] flex-col items-center hover:scale-110 transition-all justify-center ">
          <FaClock className="text-4xl mb-2  text-blueColor" />

          <h1 className="tracking-wide font-semibold text-blueColor text-2xl">
            Emergency Works{" "}
          </h1>
          <p className="text-white font-bold text-2xl my-2">+213 56555554</p>
          <h1 className="bg-blueColor px-4 py-1 text-white rounded-full font-bold">
            Call Us{" "}
          </h1>
        </div>
        <div className="flex bg-blueColor  w-[400px] h-[350px] p-10  flex-col items-cnter justify-center ">
        ...
        <div className="flex bg-orangeColor w-[300px] h-[250px] flex-col items-center    hover:scale-110 transition-all justify-center ">
          ...
          <p className="text-white font-bold text-2xl my-2">034 23470</p>
          <h1 className="bg-blueColor px-4 py-1 text-white rounded-full font-bold">
            Reach Us{" "}
          </h1>
        </div>
