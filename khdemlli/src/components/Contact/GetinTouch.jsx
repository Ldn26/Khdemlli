...
function GetinTouch() {
  ...
  return (
    <div className="container my-10 mx-auto bg-[#F4F4F4] py-10 flex items-center flex-col">
      ...
      >
        <div className="flex ">
          ...
          <div>
            <input
              ...
              className="placeholder:text-grayColor mx-2 font-semibold hover:shadow-lg text-sm  hover:border-2  hover:border-blueColor 
                w-[392px] p-3 border  shadow-sm outline-none -blueColor font-mainfont duration-400"
            />
          </div>
          ...
          <div>
            <input
              ...
              className="placeholder:text-grayColor  mx-2 font-semibold hover:shadow-lg text-sm  hover:border-2  hover:border-blueColor 
               w-[392px] p-3 border  shadow-sm outline-none -blueColor font-mainfont duration-200"
            />
            {errors.email && (
        ...
        <div>
          <input
            ...
            className="placeholder:text-grayColor  font-semibold hover:shadow-lg text-sm  hover:border-2  hover:border-blueColor 
               w-[800px] p-3 border  shadow-sm outline-none -blueColor font-mainfont duration-400"
          />
        </div>
        {/* Subjet  */}
        <div>
        ...
        <div>
          <textarea
            {...register("content", {})}
            className="w-[800px] p-2 placeholder:text-grayColor font-mainfont font-semibold"
            rows={2} // Number of visible text lines
            cols={60} // Number of visible text columns
